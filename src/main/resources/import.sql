...
insert into PATIENT (PATIENTID, USERNAME, PASSWORD, NAME, WEIGHT, HEIGHT, AGE) values (PATIENT_SEQ.NEXTVAL, 'robbo', 'password', 'Joe', '80kg', '180cm', 40);

insert into MEDICATION (MEDICATIONID, NAME, DOSAGE, CONDITION, TIMESAWEEK, TIMESADAY, TIMETOTAKE, QUANTITY, PILLSLEFT, REFILL) values (MEDICATION_SEQ.NEXTVAL, 'Paracetamol', '250mg', 'Sore Head', 7, 4, parsedatetime('17 Mar 2012 09:00', 'dd MMM yyyy hh:mm'), 2, 32, 0); 
